...
# Session Title: Generating Interactive Environments for Synthetic Training Data

Welcome to the **Generating Interactive Environments for Synthetic Training Data** session of the DevFest AI Workshop! This session will guide you through [brief session purpose or topic].
...
cd devfest-ai-workshop/sessions/session_8
```
...
1. Launch Jupyter Notebook:
   ...
   jupyter notebook
   ```
2. Open the file `session_8.ipynb`.
...
If you need help with any part of the session, refer to the [solution file](../solutions/session_8_solution.ipynb) in the `solutions` folder.
